      ...
      <div className="relative flex flex-col items-center">
        ...
        <a href="https://chargebee.com" target="_blank" rel="noreferrer">
          <Image
            width={100}
            height={100}
            src="/images/bot_hero/conv.svg"
            alt=""
            className="pulse h-24 w-24 cursor-pointer select-none hue-rotate-15 transition opacity-100 hover:brightness-125 grayscale-0"
          />
        </a>
        <div className="mb-8" />
