...
import { env } from "../../../cool_hero/src/env/client.mjs";
import { trpc } from "../../../cool_hero/src/utils/trpc";
import { initChargebee } from "../../../cool_hero/src/utils/helpers";
        ...
        <div>
          ...
          <div className="my-12 flex flex-col items-center space-y-4 sm:mt-8 sm:grid sm:grid-cols-3 sm:gap-6 sm:space-y-0 md:mx-auto md:max-w-2xl">
            <div className="flex items-center justify-start">
              ...
              >
                <img
                  src="/solid-nextjs/bot_hero/public/nextjs.svg"
                  alt="Next.js Logo"
            ...
            <div className="flex items-center justify-start">
              ...
              >
                <img
                  src="/solid-nextjs/bot_hero/public/chargebee.svg"
            ...
            <div className="flex items-center justify-start">
              ...
              >
                <img
                  src="/solid-nextjs/bot_hero/public/github.svg"
                  alt="github.com Logo"
